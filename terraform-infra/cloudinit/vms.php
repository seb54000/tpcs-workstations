...
echo "<i>  Exemple : ssh vmxx@vmxx.tpcsonline.org (ou utiliser un client RDP)</i></br>";
...
echo "<h3><a href=\"https://access.tpcsonline.org/\" target=\"_blank\">Accès Guacamole (bureau RDP pour votre VM)</a></h3>";
